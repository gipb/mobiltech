...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='mobiltech',
                             help='coco | kitti | coco_hp | pascal | mobiltech')
    ...
    # test
    self.parser.add_argument('--flip_test', action='store_false',
    ...
    self.parser.add_argument('--flip', type = float, default=1.5,
    ...
    # ctdet
    #####################################################################
    #         modify here ( set the hyperparameter (losses) )           #
    #####################################################################
  ...
  def parse(self, args=''):
    ...
    #####################################################################
    #               modify here ( set save directory )                  #
    #####################################################################
    opt.root_dir = os.path.join('/mnt','nas')
    opt.data_dir = os.path.join(opt.root_dir, 'data')
    opt.exp_dir = os.path.join(opt.root_dir,'centernet', 'exp', opt.task)
    opt.save_dir = os.path.join(opt.exp_dir, 'mobiltech', opt.exp_id)
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 512], 'num_classes': 66, 
